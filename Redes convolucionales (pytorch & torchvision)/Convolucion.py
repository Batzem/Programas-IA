...
batch_size = 4    # subconjutos de datos
...
# Las tranformamos a tensores de rango normalizado [-1, 1]
#---------------------------------------------------------------
transform = transforms.Compose(
    [transforms.ToTensor(),
     transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])
#---------------------------------------------------------------------------------
# CIFAR10: 60000 32x32 imágenes a color en 10 clases, con 6000 imagenes por clase
#---------------------------------------------------------------------------------
...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        # 3 entradas, 6 salidas, 5 entradas en el kernel de convolución
        self.conv1 = nn.Conv2d(3, 6, 5)
        # Máximo de una ventana de 2x2
        self.pool = nn.MaxPool2d(2, 2)
        # 6 entradas , 16 salidas , 5 entradas en el kernel de convolución
